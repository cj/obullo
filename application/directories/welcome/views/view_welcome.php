...
<p><br />Page rendered in {elapsed_time} seconds <?php if(function_exist('memory_get_usage')) {?> using {memory_usage} of memory <?php } ?> (Used Head_tag helper, Script file and Global Controller).</p>
