...
if ( ! function_exists('_get_validation_object'))
{
	function &_get_validation_object()
	{
		...
		if ( ! isset($OB->load->_ci_classes) OR  ! isset($OB->load->_ci_classes['form_validation']))
		{
			return $return;
		}

		$object = $OB->load->_ci_classes['form_validation'];
...
/* Location: ./base/helpers/form_helper.php */