...
/**
 * Obullo Session Class
 * Mainly derived from Code Igniter's Session Class
 * 
 * @package      Obullo
...
class OB_Session {
    ...
    /**
    * Automatically instatiate to session
    *  
    * @param array $params
    * @version 1.0
    * @return void
    */
    function __construct($params = array())
    {
        ...
        foreach ($main as $key)
        $this->$key = (isset($params[$key])) ? $params[$key] : ob::config_item($key);
