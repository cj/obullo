    ...
    private function _validate_request($segments)
    {
        ...
        {        
            ...
            if (count($segments) > 0)
            {
                ...
                if ( ! file_exists(APP.'controllers'.DS.$this->fetch_directory().$segments[0].EXT))
                {
            ...
            else
            {
                ...
                if ( ! file_exists(APP.'controllers'.DS.$this->fetch_directory().$this->default_controller.EXT))
                {
                    $this->directory = '';
                    return array();
                }
